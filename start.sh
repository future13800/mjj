...
export TLS=${TLS:-'1'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'glitch1.future13800.cf'}
export WEB_DOMAIN=${WEB_DOMAIN:-'glitch1.future13800.cf'}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiNjc0MmMxNDI5ZDE4OTA3NjMzZjMyZjQ2MWM5MzUwOWMiLCJ0IjoiOTMyZjMyNWQtZmFhYS00YjM1LThiZTYtYjNiNWQzOTE0NGY0IiwicyI6Ik5UTmpNemRtTm1JdE1EbGtZaTAwTUdaakxXSXdPRFF0WVRSbFlUZG1Zek5qTVRjeiJ9'}
export WSPATH=${WSPATH:-'argo'}
export UUID=${UUID:-'0c3287fe-af8a-4709-a4d1-de12048de838'}
